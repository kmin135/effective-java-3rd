...
public class StaticFactoryMethod {
    public static void main(String[] args) throws IOException {
        ...
        이를 통해 개발자가 익혀야할 API를 최소화하고 개발자는 인터페이스만으로 해당 객체를 다루게됨 (아이템 64)
        ...
        /*
        EnumSet (아이템 36)을 예로 들면 allOf 메서드의 경우
        ...
        3. java5부터는 java.util.ServiceLoader (아이템 59) 라는 범용 서비스 제공자 프레임워크가 제공됨
        */
        ...
        그러나 상속보다는 컴포지션을 사용하도록 유도하고 (아이템 18)
        불변 타입(아이템 17)으로 만들려면 이 제약을 지켜야한다는 점에서 장점이기도 함
         */
